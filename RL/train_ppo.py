...
def parse_args():
    ...
    parser.add_argument('--env_type', type=str, choices=['brax', 'isaac'], default='brax', help='Whether to use cpu-envs or gpu-envs for rollouts')
    # args for brax
...
if __name__ == '__main__':
    ...
    if cfg.use_wandb:
        config_wandb(cfg=cfg, batch_size=cfg.batch_size, total_steps=cfg.total_timesteps, \
                     run_name=cfg.wandb_run_name, wandb_group=cfg.wandb_group, \
                     wandb_project=cfg.wandb_project)

    alg = PPO(cfg)
    # num_updates = cfg.total_timesteps // cfg.batch_size
    num_updates = cfg.total_iterations
